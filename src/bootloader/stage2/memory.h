...
/**
 * @brief Converts a segment:offset real mode address to a linear physical address.
 * @param p_segment The segment address
 * @param p_offset The offset address
 * @returns The linear physical address
 */
