...
// Flag that is enabled whenever there are 512 characters in the charset for the PSF file. If not, there are 256
// characters.
#define PSF1_MODE512 0x01
// Flag if the PSF1 file has a table after the bitmaps. If not, then glyphs are stored in their sequential Unicode
// order.
...
/**
 * @brief Struct for the header of a PSF1 file. PSF1 files always have characters that are 8 bits in width and
 * `char_size` in height. PSF1 and PSF2 act different and hence should be parse differently.
 */
struct PSF1_Header
{
